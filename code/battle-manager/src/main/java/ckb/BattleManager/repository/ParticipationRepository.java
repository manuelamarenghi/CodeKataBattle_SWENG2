...
public interface ParticipationRepository extends JpaRepository<Participation, ParticipationId> {
    ...
    @Query("SELECT t FROM Participation p JOIN Team t ON p.participationId.teamId = t.teamId WHERE p.participationId.studentId = :studentId AND t.battle.battleId = :battleId")
